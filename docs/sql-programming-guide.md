...
## Upgrading From Spark SQL 2.3 to 2.4
 ...
 - Since Spark 2.4, expression IDs in aliases do not appear in `Dataset.show` and `Dataset.explain`. For example, aliases in Spark 2.4 are not `col0 AS colA#28` but ``(col0 AS `colA`)``.
